...
//----------------------------------------------------------------------------------------------------
	...
	this.bgColor = "#E5E0C3";			// background color
	this.textFont = "Tahoma, Geneva, sans-serif";	// text font family
	this.textSize = 12;					// text font size (pixels)
	this.textColor = "#4a4945";			// text color
	this.textAlign = "center";			// text alignment: "left", "right" or "center"
	this.border = "1px solid #575652";  // border (CSS spec: size style color, e.g. "1px solid #D00000")
...
function toolTip(text, size, position_horizontal, opacity, padding, border) {
	if(typeof text != 'undefined') {
		...
		if(position_horizontal) tooltip.xPos = position_horizontal;
